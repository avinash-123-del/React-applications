...
const Contact = () => {
    return (
        <div name='contact' className='bg-gradient-to-b from-black to-gray-800 w-full text-white pt-10 h-[100vh]'>
            <div className='flex flex-col justify-center px-4 max-w-screen-lg mx-auto h-full'>
                <div className='pb-8'>
